...
func (c *trackerClient) GetPeers(ctx context.Context, in *GetPeersRequest, opts ...grpc.CallOption) (*GetPeersReply, error) {
	out := new(GetPeersReply)
	err := c.cc.Invoke(ctx, "/tracker.Tracker/GetPeers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTrackerServer) GetPeers(context.Context, *GetPeersRequest) (*GetPeersReply, error) {
...
func _Tracker_GetPeers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tracker.Tracker/GetPeers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
